...
# DOWNLOAD COVID DATA
docker exec jupyterds2 jupyter nbconvert --execute --to notebook /home/jovyan/work/2_download_rki_data.ipynb
# PREPROCESS DATA = TRAIN + COVID
docker exec jupyterds2 jupyter nbconvert --execute --to notebook /home/jovyan/work/4_preprocess_for_simulation.ipynb
